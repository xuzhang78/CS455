...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnAssignment2Unsharpmask();
	afx_msg void OnAssignment2Sobel();
	afx_msg void OnLogmasksMask1();
	afx_msg void OnLogmasksMask2();
	afx_msg void OnAssignment2Cannyedge();
	afx_msg void OnAssignment2Zero();
	afx_msg void OnZeroMask1();
	afx_msg void OnZeroMask211();
};
